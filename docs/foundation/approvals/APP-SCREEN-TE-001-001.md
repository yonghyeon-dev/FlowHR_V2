# APP-SCREEN-TE-001-001

- approvalId: `APP-SCREEN-TE-001-001`
- targetType: `screen`
- targetId: `TE-001`
- title: `Employee Home`
- requestedBy: `user`
...
- decision: `hold`
- reason: `Office / Retail 직원 홈 변형으로 재구성됐지만 번들 승인 전이라 보류`
- followUp: `Office 또는 Retail 번들 승인 결과에 맞춰 screen decision을 갱신`
- packContext: `shared`
- variant: `office_employee_home | retail_employee_home`
