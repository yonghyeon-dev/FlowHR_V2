...
| `TA-101`~`TA-105` | `WI-TA-002` | 있음 | 목록/상세 | 방향 정의 | 없음 | `R3` |
| `TA-201` | `WI-TA-003` | 있음 | 요약/예외/액션 | 방향 정의 | `hold` | `R4` |
| `TA-202`~`TA-205` | `WI-TA-003` | 있음 | 요약/예외/액션 | 방향 정의 | 없음 | `R3` |
| `TA-301`~`TA-304` | `WI-TA-004` | 있음 | 목록/액션 | 방향 정의 | 없음 | `R3` |
| `TA-401`~`TA-404` | `WI-TA-005` | 있음 | 목록/상세/액션 | 방향 정의 | 없음 | `R3` |
| `TA-501`~`TA-504` | `WI-TA-006` | 있음 | 목록/액션 | 방향 정의 | 없음 | `R3` |
| `TA-601`~`TA-604` | `WI-TA-010` | 있음 | 요약/실행 | 적용 | 없음 | `R4` |
| `TA-701`~`TA-704` | `WI-TA-008` | 있음 | 요약/상세 | 적용 | 없음 | `R4` |
| `TA-801`~`TA-805` | `WI-TA-009` | 있음 | 목록/상세 | 적용 | 없음 | `R4` |
| `TA-901`~`TA-904` | `WI-TA-011` | 있음 | 요약/내보내기 | 적용 | 없음 | `R4` |
| `TA-1001`~`TA-1005` | `WI-TA-007` | 있음 | 상세/액션 | 방향 정의 | 없음 | `R3` |
...
| `TE-102` | `WI-TE-002` | 있음 | 액션형 | 방향 정의 | 없음 | `R3` |
| `TE-201` | `WI-TE-003` | 있음 | 목록/폼 | 방향 정의 | `hold` | `R4` |
| `TE-202`~`TE-205` | `WI-TE-003` | 있음 | 목록/폼 | 방향 정의 | 없음 | `R3` |
| `TE-401`, `TE-402` | `WI-TE-004` | 있음 | 목록/상세/실행 | 방향 정의 | 없음 | `R3` |
